...
public class ClosedHashTable<T> extends AbstractHash<T> {
	 ...
	 * 
	 * @return <p>true: en caso de que el factor de carga sea mayor a la carga maxima</p>
	 * <p>false: en caso de que el factor de carga sea menor a la carga maxima</p>
	 */
	@Override
	 ...
	 * Se crea la nueva tabla y se inicializa. Se incluyen tambien los elementos de la tabla vieja.
	 * 
	 * @return <p>true: en caso de que el factor de carga sea menor al minimo</p>
	 * <p>false: en caso contrario</p>
	 */
	@Override
