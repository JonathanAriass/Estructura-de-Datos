...
/**
 * Clase de pruebas del algoritmo de Floyd
 * 
...
class FloydTest {
	...
	public void floydPathTest2() {
		fullGraph.floyd();
		//1	(4.0)	3	(3.0)	5	(3.0)	6
		String expected = "1" +"\t" +"(4.0)" + "\t" + "3" + "\t" + "(3.0)" + "\t" + "5" + "\t" + "(3.0)" + "\t" + "6";
		assertEquals(expected, fullGraph.path(1, 6));
	}
	 ...
	 */
	@Test
	public void floydPathTest4() {
		graph.floyd();
		//1	(3.0)	2	(2.0)	3	(4.0)	4
		String expected = "1" +"\t" +"(3.0)" + "\t" + "2" + "\t" + "(2.0)" + "\t" + "3" + "\t" + "(4.0)" + "\t" + "4";
		assertEquals(expected, graph.path(1, 4));
	}
