...
class GraphTest {
	...
	Graph<Integer> graphFuertementeConexo;
...
//		graph1.addEdge(2, 1, 2);
		...
		graphFuertementeConexo = new Graph<Integer>(4);
		graphFuertementeConexo.addNode(1);
		graphFuertementeConexo.addNode(2);
		graphFuertementeConexo.addNode(3);
		graphFuertementeConexo.addNode(4);
		graphFuertementeConexo.addEdge(1, 2, 1);
		graphFuertementeConexo.addEdge(1, 3, 1);
		graphFuertementeConexo.addEdge(3, 4, 1);
		graphFuertementeConexo.addEdge(2, 4, 1);
		graphFuertementeConexo.addEdge(4, 1, 1);
	}
	...
	void excentridadNodoTest1() {
		graph3.floyd();
		assertEquals(5, graph3.excentridadNodo(4));
		Assert.assertArrayEquals(new double[] {Double.POSITIVE_INFINITY,6,8,5,7}, graph3.excentridadFullNodos(), 0);
	}
	
	@Test
	void nodoConexoTest1() {
		assertTrue(graph3.nodeIsConexo(1));
	}
	
	@Test
	void nodoConexoTest2() {
		assertFalse(graph3.nodeIsConexo(2));
	}
	
	@Test
	void grafoFuertementeConexoTest1() {
		assertTrue(graphFuertementeConexo.isGraphFuertementeConexo());
	}
	
	@Test
	void grafoFuertementeConextoTest2() {
		assertFalse(graph3.isGraphFuertementeConexo());
	}
